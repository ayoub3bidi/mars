...
os.environ.setdefault("APP_TITLE", "Mars")
os.environ.setdefault("APP_DESCRIPTION", "Mars API")
os.environ.setdefault("API_VERSION", "v1")
os.environ.setdefault("POSTGRES_DB", "mars")
os.environ.setdefault("POSTGRES_USER", "mars")
os.environ.setdefault("POSTGRES_PASSWORD", "mars")
